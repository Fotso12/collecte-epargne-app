...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 2. Pas de token ou format invalide → on laisse passer à la suite de la chaîne Spring Security
        ...
        try {
            ...
            // Si le token est présent mais mal formé/expiré, on refuse l'accès proprement
        ...
        if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            // Vérification supplémentaire de validité du token (si implémenté dans jwtService)
